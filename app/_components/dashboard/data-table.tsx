...
import {
  ...
  type DataTableRow,
  type DataTableSort,
} from "@/lib/dashboard/data-table-utils.js";

export type { ColumnKind, ColumnSpec, DataTableRow } from "@/lib/dashboard/data-table-utils.js";
...
export function DataTable({
  ...
  const filterValues = useMemo(() => {
    return getDataTableFilterValues(rows, filterKey);
  }, [rows, filterKey]);

  const visible = useMemo(() => {
    return getVisibleDataTableRows({
      columns,
      rows,
      query,
      filter,
  ...
  function toggleSort(key: string) {
    setSort((prev) => nextDataTableSort(prev, key));
  }
