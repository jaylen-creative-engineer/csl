...
import { cellValue, filterCounts, nextSortState, visibleRows } from "./data-table-utils.js";
import type { ColumnKind, ColumnSpec, DataTableRow, SortState } from "./data-table-utils.js";
...
export function DataTable({
  ...
  const filterValues = useMemo(() => {
    return filterCounts(rows, filterKey);
  }, [rows, filterKey]);

  const visible = useMemo(() => {
    return visibleRows({ columns, rows, query, filterKey, filter, searchKeys, sort });
