...
export function DataTable({
  ...
  const filterValues = useMemo(() => getFilterValues(rows, filterKey), [rows, filterKey]);

  const visible = useMemo(
    () => getVisibleRows({ rows, columns, query, searchKeys, filterKey, filter, sort }),
    [rows, columns, query, searchKeys, filterKey, filter, sort],
  );
