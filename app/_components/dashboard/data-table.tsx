 ...
 *  - "text"     → plain text
 */
export type { ColumnKind, ColumnSpec, DataTableRow, SortSpec } from "./data-table-utils.js";
...
export function DataTable({
  ...
  const filterValues = useMemo(() => {
    return getFilterCounts(rows, filterKey);
  }, [rows, filterKey]);

  const visible = useMemo(() => {
    return deriveVisibleRows({ rows, columns, query, filter, filterKey, searchKeys, sort });
