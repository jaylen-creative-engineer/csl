...
Given("a league {string} with host {string}", async function (
  this: CslWorld,
  leagueName: string,
  hostName: string
) {
...
Given("a participant {string} with discipline {string}", async function (
  this: CslWorld,
  handle: string,
  discipline: string
) {
...
When("{string} submits an artifact URL {string}", async function (
  this: CslWorld,
  _handle: string,
  url: string
) {
  ...
  try {
    this.lastSubmission = await this.challengeService.submitEntry(
